(function (window){
	...
	window.JCCatalogItem.prototype = {
		...
		setCompared: function(state)
		{
			...
			var checkbox = this.obCompare.querySelector('[data-entity="compare-checkbox"]');
			var compare_icon = this.obCompare.querySelector('.item-compare-svg-icon');
			if (checkbox)
			{
				checkbox.checked = state;
				if(state) compare_icon.classList.add('active');
					else compare_icon.classList.remove('active');
			}
		},
