...
$generalParams = array(
    ...
    '~WISHLIST_URL_TEMPLATE' => str_replace("COMPARE","WISHLIST", $arResult['~COMPARE_URL_TEMPLATE']),
    '~WISHLIST_DELETE_URL_TEMPLATE' => str_replace("COMPARE","WISHLIST", $arResult['~COMPARE_DELETE_URL_TEMPLATE']),
